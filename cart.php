                            ...
                            <?php if (!empty($_SESSION['cart_item'])) : ?>
                                <form action="" method="POST">
                                    <div class="table-responsive">
                                        <table class="table align-middle">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="5"><b>&nbsp;&nbsp;&nbsp;**1 shirt weighs 400 g.</b></td>

                                                </tr>
                                                <tr>
                                                    <td colspan="5"><b>&nbsp;&nbsp;&nbsp;ฺ**Delivered by Fastship Express working 5-10 days</b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <br>
                                    ...
                                    <div class="btn-group float-end">
                                        ...
                                        <a href="../shop/login.php" class="btn btn-warning">Place an order</a>
