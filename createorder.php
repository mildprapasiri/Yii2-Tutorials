...
<body>
    ...
    if (isset($_SESSION['cart_item']) && isset($_POST['submit'])) {
        try {
            ...
            $sql = "INSERT INTO orders (order_name, order_email, order_phone, order_address, order_city, order_state, order_zipcode, created_at, updated_at) 
                    VALUES (:order_name, :order_email, :order_phone, :order_address, :order_city, :order_state, :order_zipcode, :created_at, :updated_at)";
            ...
            if ($lastInsertId) {
                foreach ($_SESSION['cart_item'] as $value) {
                    ...
                    $paramsDetail = array(
                        ...
                        'order_detail_price' =>  $value['p_price'] * $value['p_amount'],
                ...
                <div class="container-fluid">
                    <a href="./" aria-current="page" class="navbar-brand">
                        <span class="brand-center">
                            <img src="" width="50px" class="me-2">
                            <span class="d-none d-md-block"> Thai Traditional Cloth </span>
                        </span>
                    </a>
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-0 mb-3">
                        <div class="card-body text-center">
                            ...
                            <tr class="list-group">
                                <td class="list-group-item border-0">Order Code: #<?php echo str_pad($lastInsertId, 5, '0', STR_PAD_LEFT); ?> </td>
                                <td class="list-group-item border-0">First and last name: <?php echo $_POST['order_name'] ?> </td>
                                <td class="list-group-item border-0">Order time: <?php echo date("d/m/Y H:i:s") ?> </td>

                            </tr>
                            <hr>
                            <?php
                            $total = $value['p_price'] * $value['p_amount'];
                            // echo 'Total' . $total;

                            ?>
                            <form name="checkoutForm" method="POST" action="check.php">
                                <script type="text/javascript" src="https://cdn.omise.co/omise.js" data-key="pkey_test_5qpva0cg7bbpicpg4sh" data-image="http://bit.ly/customer_image" data-frame-label="devbanban Shop" data-button-label="Payment" data-submit-label="Payment" data-location="no" data-amount="<?php echo $total; ?>00" data-currency="USD">
                                </script>
